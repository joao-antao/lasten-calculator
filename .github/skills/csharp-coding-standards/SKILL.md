...
- [composition-and-error-handling.md](composition-and-error-handling.md): Composition and inheritance, Result type, testing patterns
...
7. **Composition and Inheritance** - Use when reducing code duplication.
